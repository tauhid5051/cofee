...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h1 class="modal-title" id="myModalLabel"><?= lang($reportType); ?></h1>
        </div>
        ...
        <div class="modal-body">
            ...
            <div id="form">
                ...
                $attributes = array('method' => 'post', 'autocomplete="off"', 'target' => '_blank');
                // echo form_open($this->config->item('mis_api') . 'generateReport.do', $attributes);
                echo admin_form_open('mis_reports/createJasper',  $attributes);
                echo form_hidden('reportType', $reportType);
                ...
                echo form_hidden('subtype', $subtype);
                echo form_hidden('subReport', $subReport);
                ...
                <div class="modal-footer">
                    ...
                    <div style=" display: inline; " class="controls"> <?php echo form_submit('submit_report', $this->lang->line("View Report"), 'class="btn btn-primary "'); ?> </div>
