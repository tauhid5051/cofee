...
$('.report_date').datetimepicker({ format: 'yyyy-mm-dd', fontAwesome: true, language: 'sma', todayBtn: 1, autoclose: 1, minView: 2 });

$(document).on('focus', '.report_date', function () {
    $(this).datetimepicker({ format: 'yyyy-mm-dd', fontAwesome: true, weekStart: 1, todayBtn: 1, autoclose: 1, todayHighlight: 1, startView: 2, forceParse: 0 });
});
